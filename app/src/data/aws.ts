...
export const awsQuestions: QuizQuestion[] = [
    {
        id: 1, bank: 'aws', domain: 'cloud',
    ...
    {
        id: 10, bank: 'aws', domain: 'security',
    ...
    {
        id: 11, bank: 'aws', domain: 'security',
    ...
    {
        id: 12, bank: 'aws', domain: 'security',
    ...
    {
        id: 13, bank: 'aws', domain: 'security',
